      ...
      <Container>
        <div className="mt-[160px] md:mt-[200px]">
          ...
          <div className={`${styles.content}`}>
            ...
            <p>こっちの方がわかりやすいし、いざというときに迷わなくて済みます。</p>
            <p>
              だから私にとって「自分が好きなこと」は、さして重要ではなく、それよりも<strong>「好きな人のためにやること」</strong>の方が重要なのです。
            </p>
